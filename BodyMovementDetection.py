...
DATA_PATH = os.path.join('MP_Data2')   #path for data to export
actions = np.array(['hello','thankyou','iloveyou'])
no_sequences=30
sequence_length=30 #videos with 30 frame
